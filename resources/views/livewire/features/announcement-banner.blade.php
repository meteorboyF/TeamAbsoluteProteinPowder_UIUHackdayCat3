<div>
    @if($announcement && $isVisible)
        <div
            class="w-full px-4 py-3 flex justify-between items-center {{ $announcement->type == 'warning' ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-600 text-white' }}">
            ...
            <button wire:click="dismiss" class="opacity-75 hover:opacity-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
